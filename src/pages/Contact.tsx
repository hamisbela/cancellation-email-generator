          ...
          <div className="space-y-8">
            <div className="gradient-border">
              <Card className="p-8 space-y-4">
                ...
                <p className="text-gray-600">contact@cancellationemailgenerator.com</p>
              </Card>
            </div>
            ...
            <div className="gradient-border">
              <Card className="p-8 space-y-4">
                ...
                <p className="text-gray-600">@CancelEmailGen</p>
              </Card>
            </div>
          ...
          <div className="gradient-border">
            <Card className="p-8">
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <Button 
                  type="submit" 
                  className="w-full h-12 text-lg bg-gradient-to-r from-blue-500 to-blue-700 hover:from-blue-600 hover:to-blue-800"
                >
